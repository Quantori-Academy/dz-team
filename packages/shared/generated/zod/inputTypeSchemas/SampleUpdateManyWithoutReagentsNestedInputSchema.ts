...
export const SampleUpdateManyWithoutReagentsNestedInputSchema: z.ZodType<Prisma.SampleUpdateManyWithoutReagentsNestedInput> =
    z
        .object({
            create: z
                .union([
...
export default SampleUpdateManyWithoutReagentsNestedInputSchema;
