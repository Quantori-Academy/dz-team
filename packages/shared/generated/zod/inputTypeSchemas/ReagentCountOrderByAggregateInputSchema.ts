...
export const ReagentCountOrderByAggregateInputSchema: z.ZodType<Prisma.ReagentCountOrderByAggregateInput> =
    z
        .object({
...
export default ReagentCountOrderByAggregateInputSchema;
