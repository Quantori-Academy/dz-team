...
export const SampleCreateNestedManyWithoutReagentsInputSchema: z.ZodType<Prisma.SampleCreateNestedManyWithoutReagentsInput> =
    z
        .object({
            create: z
                .union([
...
export default SampleCreateNestedManyWithoutReagentsInputSchema;
