...
export const ReagentMinOrderByAggregateInputSchema: z.ZodType<Prisma.ReagentMinOrderByAggregateInput> =
    z
        .object({
...
export default ReagentMinOrderByAggregateInputSchema;
