...
export const ReagentCreateNestedManyWithoutSamplesInputSchema: z.ZodType<Prisma.ReagentCreateNestedManyWithoutSamplesInput> =
    z
        .object({
            create: z
                .union([
...
export default ReagentCreateNestedManyWithoutSamplesInputSchema;
