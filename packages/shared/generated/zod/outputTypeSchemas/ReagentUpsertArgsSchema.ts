...
import { ReagentUpdateInputSchema } from "../inputTypeSchemas/ReagentUpdateInputSchema";
import { ReagentUncheckedUpdateInputSchema } from "../inputTypeSchemas/ReagentUncheckedUpdateInputSchema";
...
export const ReagentUpsertArgsSchema: z.ZodType<Prisma.ReagentUpsertArgs> = z
    .object({
        select: ReagentSelectSchema.optional(),
        include: ReagentIncludeSchema.optional(),
        where: ReagentWhereUniqueInputSchema,
        create: z.union([ReagentCreateInputSchema, ReagentUncheckedCreateInputSchema]),
        update: z.union([ReagentUpdateInputSchema, ReagentUncheckedUpdateInputSchema]),
    })
    .strict();

export default ReagentUpsertArgsSchema;
