...
export const ReagentUpdateArgsSchema: z.ZodType<Prisma.ReagentUpdateArgs> = z
    .object({
        select: ReagentSelectSchema.optional(),
        include: ReagentIncludeSchema.optional(),
        data: z.union([ReagentUpdateInputSchema, ReagentUncheckedUpdateInputSchema]),
        where: ReagentWhereUniqueInputSchema,
    })
    .strict();

export default ReagentUpdateArgsSchema;
